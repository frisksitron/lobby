...
DEFAULT_BLOB_ROOT="/data/blobs"
DEFAULT_UPLOAD_MAX_BYTES="10485760"
...
collect_config() {
  ...
  LOBBY_BLOB_ROOT="$DEFAULT_BLOB_ROOT"
  LOBBY_UPLOAD_MAX_BYTES="$DEFAULT_UPLOAD_MAX_BYTES"
}
...
LOBBY_BLOB_ROOT=${LOBBY_BLOB_ROOT}
LOBBY_UPLOAD_MAX_BYTES=${LOBBY_UPLOAD_MAX_BYTES}
EOF
  chmod 600 "$ENV_FILE"
}
